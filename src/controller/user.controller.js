...
const updateUserAvtar = asynchandler(async (req, res) => {
    ...
    if (user.avtar?.public_id) {
        await deletefilefromCloudinary(user.avtar.public_id)
    }
...
const updateUserCoverImage = asynchandler(async (req, res) => {
    ...
    // 5️⃣ Delete old image (after successful update)
    if (oldPublicId) {
...
//         await deletefilefromCloudinary(user.coverImage.public_id)
//     }
...
export {
    userRegister, loginUser, logoutUser,
    refreshAccessToken,
    changePassword,
    getCurrentUser,
    updateAccountDetail,
